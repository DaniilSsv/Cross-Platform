...
const getStyles = (isDarkTheme) =>
    StyleSheet.create({
        ...
        compactCarDetails: {fontSize: 16,fontWeight: 'bold',color: isDarkTheme ? '#EDD6C8' : '#313131',textAlign: 'center', marginTop: 10, marginBottom: 5},
        compactCarSubDetails: {fontSize: 14,color: isDarkTheme ? '#EDD6C8' : '#313131',textAlign: 'center',fontStyle: 'italic', marginBottom: 5},
